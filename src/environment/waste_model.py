...
class WasteGenerationModel:
    ...
    def generate_for_node(
        ...
        # Demand-intensity sensitivity: optional multiplicative scaling of the
        # realised generation (default 1.0 preserves the original behaviour).
        total *= getattr(self, "_demand_scale", 1.0)
